...
def main(config = None): 
    # Logging
    log_dir = "./runs/baseline_gearbox_100epoch"
    wandb.tensorboard.patch(root_logdir = log_dir)
    wandb.init(
        project="dcase_2025_t02_tb",
        sync_tensorboard=True,
        dir="./runs/baseline_ToyTrain_300epoch",  # Optional: makes log scanning easier
    )
    writer = SummaryWriter(log_dir = log_dir) 

    dataset_path = "../data/unziped/dev/" + class_names[0] + "/train/*" # DCASE Original
    print(dataset_path) 
